-- Let any active inventory staff member add audited updates to pending-order
-- coordination tasks. Reassignment remains protected by the existing
-- trg_ebay_order_tasks_admin_only_reassignment trigger.
