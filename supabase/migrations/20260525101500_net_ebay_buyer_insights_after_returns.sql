-- Keep buyer insights from overstating value when a buyer has returns.
-- Returned orders remain visible in return history, but net buyer value,
-- average order, item mix, and top-item rollups exclude return exposure.
