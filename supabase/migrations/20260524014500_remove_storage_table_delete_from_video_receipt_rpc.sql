-- Supabase blocks direct deletes from storage.objects in SQL functions.
-- Keep the coordination cleanup in the RPC; the app removes the storage object
-- through the Storage API after the attachment is removed from task events.
