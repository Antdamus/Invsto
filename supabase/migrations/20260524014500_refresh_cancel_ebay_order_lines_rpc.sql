-- Refresh the worker cancellation RPC signature used by pending-orders.js.
-- This keeps the database aligned with the frontend call that includes
-- cancellation evidence photos, and asks PostgREST to reload its schema cache.
