-- Step 5F.6A.2B unclassified queue visibility.
-- Extends the existing canonical mailbox read model with a DB-derived
-- Unclassified smart folder. Read-only: does not mutate eBay, sync, or
...
comment on function public.get_ebay_canonical_mailbox_v2(integer, integer, text, text[], jsonb, jsonb)
  is 'Versioned canonical eBay mailbox read model. Read-only; derives source from ebay_conversations.conversation_type and exposes DB-derived smart folder counts including unclassified conversations.';
...
values
  (
    'Unclassified',
    'Canonical eBay conversations with no current AI classification.',
    '{"version":1,"system_filter":"unclassified","search_query":"","classification_filters":{"sourceTypes":[],"topics":[],"buyerFlags":[],"riskFlags":[],"priorities":[],"responseNeeds":[]}}'::jsonb,
    'unclassified',
    true,
    21
  )
