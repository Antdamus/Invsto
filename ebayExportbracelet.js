...
window.exportToEbayXLSX = async function (items) {
  ...
  reader.onload = async (e) => {
    ...
    for (const item of items) {
      ...
      row[headers.indexOf(requiredHeaders.categoryid)] = "261988";
      row[headers.indexOf(requiredHeaders.category)] = "/Jewelry & Watches/Fine Jewelry/Bracelets & Charms";
      ...
      row[headers.indexOf(requiredHeaders.style)] = "Tennis";
      row[headers.indexOf(requiredHeaders.type)] = "Bracelet";
